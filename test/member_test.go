...
func TestGetMember(t *testing.T) {
	...
	var dataInsertMember = []model.Member{
		...
		model.Member{Username: "Rahmat", Password: "Rahmat", Status: "2", NamaMember: "Rahmat@gmail.com", NoHp: "80890", Email: "Rahmat@gmail.com", Alamat: "jl rahmat", Foto: "rahmat.jpg", IDMember: "1", Flag: "1", Nik: "3123213"},
	}
	db, err := initDatabase()
	...
	if err := model.GetMemberFromAnother(db, dataInsertInvoice[0].IDMember); err != nil {
		t.Fatal(err)
	}

	fmt.Println("Sukses brooo Member")
}
